...
export const ACTION_GET_ADMIN = () => async (dispatch) => {
  ...
  try {
    ...
    let res3 = await axios.get("http://localhost:8080/products");
    let res4 = await axios.get("http://localhost:8080/games");
    let res5 = await axios.get("http://localhost:8080/accessories");
